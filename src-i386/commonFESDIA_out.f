...
!========================================================================== 
      ...
      MODULE dimFESDIA
        ...
        INTEGER, PARAMETER :: nparmsdia = 5*N + 5*(N+1) + 82
        ...
        INTEGER, PARAMETER :: Noutdia = 110 + 4400 
  ...
  ! -----------------------------------
        ...
        DOUBLE PRECISION  :: PO4(N),FeP(N),CaP(N),Pads(N),ALK(N),FeOH3B(N)
        DOUBLE PRECISION	:: Mn(N), MnO2(N), MnO2B(N)
  ...
  ! rate coefficients for Fe - Mn cycle 
        DOUBLE PRECISION :: rAgeFeox, rMnOxid, rH2SMnox, rAgeMnox, rMnFe,		   &
     &	rMnS, rMnCO3prec, ksMnO2, pFastFeOx, pFastMnOx 
  ...
  ! MnOxid flux - New Addition  
     ...
     &  MnOxid(N), MnSprod(N), MnredMin(N), Mnredlim(N)
     ...
     &   TotMnCO3prec, TotAgeFeox, TotAgeMnox
     ...
     &  TotMnred, TotMnOxid, TotMnSprod, TotMnASC, TotFeASC,                      &
     &  totH2SoxidFe, totH2SoxidMn, TotAgeMnox, TotAgeFeox,                       &
     &  TotMnCO3prec,                                                             &  
     ...
     &  DICuptake,FeOH3Bsurfflux,FeOH3Bdeepflux,Mnflux,Mndeepflux,	              &
     &  MnO2surfflux,MnO2deepflux, MnO2Bsurfflux,MnO2Bdeepflux,                   &
  ...
  ! Here the increase as in rate factor (e.g. due to temperature) is used!
     ...
     &		     (FeOxidMn + FeOxidMnB)*(1.d0-por)/por
